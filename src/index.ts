...
import { supportedVersions } from 'reinarpg-protocol'
import protocolMicrosoftAuth from 'reinarpg-protocol/src/client/microsoftAuth'
...
import MinecraftData, { versionsByMinecraftVersion } from 'reinarpg-data'
